...
Section RTAforFullyPreemptiveFPModelwithArrivalCurves.
  ...
  (** In order to account for the maximum cumulative delay that task [tsk] may
      ...
      _supply-bound function_ [SBF] that conservatively models the restriction
      of processor supply due to overheads (i.e., it lower-bounds the amount of
      "useful" processor cycles not lost to overheads).

      The overhead-aware [SBF] works by determining a _blackout bound_, which
  ...
  Proof.
    move=> L /andP[BW_POS BW_SOL] R SOL js ARRs TSKs.
