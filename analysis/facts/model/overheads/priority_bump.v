...
Section PriorityBump.
  ...
  (** In the following, we assume FIFO scheduling. *)
  Hypothesis H_JLFP_is_FIFO : policy_is_FIFO JLFP.
  ...
  Proof.
    ...
    { move: SCHED1 SCHED2; rewrite -!scheduled_at_iff_scheduled_job => SCHED1 SCHED2.
      have /negP: ~~ completed_by sched j2 t
        by apply: scheduled_implies_not_completed.
      apply; apply: (completion_monotonic _ _ t.-1); first exact: leq_pred.
      by eapply no_later_arrival_hep_job_is_scheduled with (j2 := j1). }
  Qed.
